...
const WorkAxes = () => {
  return (
    <section id="ejes" className="py-24 bg-neutral-soft">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {axes.map((axis, index) => (
            ...
            >
              <div className={`w-14 h-14 ${axis.color} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}>
                <axis.icon size={28} />
              </div>
